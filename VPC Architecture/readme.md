...
Deploying a Modular and Scalable Virtual Network Architecture with Amazon VPC.
...
11. Create Launch Configuration with below configuration.
    ...
    3. Userdata to pull the code from github Repository to document root folder of webserver and start the httpd service.
